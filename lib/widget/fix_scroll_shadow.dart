...
class FixScrollShadow extends StatefulWidget {
  /// Wraps a scrollable child in `ScrollShadow`s.
  const FixScrollShadow({
    super.key,
    this.size = 6.0,
  ...
  @override
  State<FixScrollShadow> createState() => _FixScrollShadowState();
}

class _FixScrollShadowState extends State<FixScrollShadow> {
