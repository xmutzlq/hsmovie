...
class RecommendListView extends StatefulWidget {
  ...
  RecommendListView({Key? key, required this.items, this.onItemInteraction})
    : super(key: key);
...
class _MovieListViewState extends State<RecommendListView> {
  @override
  ...
  Widget _buildContent(
    ...
    return Container(
      ...
      child: ListView.builder(
        ...
        itemCount: snapshot.data!.length > 12 ? 12 : snapshot.data!.length,
