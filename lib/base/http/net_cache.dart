...
class NetCacheInterceptor extends Interceptor {
  ...
  onRequest(RequestOptions options, RequestInterceptorHandler handler) async {
    ...
    debugPrint("cacheRefresh = " + refresh.toString());
    debugPrint("cacheDisk = " + cacheDisk.toString());
    debugPrint("noCache = " + (options.extra["noCache"] != true).toString());
