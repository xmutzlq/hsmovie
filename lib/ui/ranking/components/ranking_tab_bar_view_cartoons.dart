  ...
  return keepAliveWrapper(
    AnimatedSwitcher(
      ...
      child: GetBuilder<RankingLogic>(
        ...
        init: RankingLogic(),
        builder: (logic) {
          int _count = logic.state.cartoonVodList.length;
          return _count > 0
              ? ListView.builder(
                  cacheExtent: 500,
                  ...
                  itemBuilder: (BuildContext context, int index) => _ItemCell(
                    index: index,
                    data: logic.state.cartoonVodList[index],
                    onTap: () => {
                      Get.toNamed(
                        RouterConfigs.detail,
                        arguments: {
                          'movieId': logic.state.cartoonVodList[index].vodID,
                        },
                      ),
                    },
                  ),
