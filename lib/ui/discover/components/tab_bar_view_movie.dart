...
Widget movieView() {
  ...
  return keepAliveWrapper(AnimatedSwitcher(
    key: const Key("movieView"),
    duration: const Duration(milliseconds: 600),
    child: GetBuilder<DiscoveryLogic>(builder: (logic) {
      int _count = logic.state.discoveryGroups?.length ?? 0;
      return _count > 0 ? RefreshIndicator(
        child: SizeCacheWidget(
          ...
          child: GroupedListView<DiscoveryGroupInfo, String>(
            ...
            elements: logic.state.discoveryGroups!,
      ...
      ListView.separated(
        ...
        itemBuilder: (_, index) {
          return Offstage(
            offstage: logic.state.page == logic.state.totalPages && _count > 0,
