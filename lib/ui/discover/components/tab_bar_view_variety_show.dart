  ...
  return keepAliveWrapper(AnimatedSwitcher(
    ...
    child: GetBuilder<DiscoveryLogic>(builder: (logic) {
      ...
      return _count > 0 ? RefreshIndicator(
          ...
          onRefresh: () async {
            logic.getVarietyShowDataWithRefresh();
            String type = "3";
        ...
        itemBuilder: (_, index) {
          return Offstage(
            offstage: logic.state.vsPage == logic.state.vsTotalPages && _count > 0,
